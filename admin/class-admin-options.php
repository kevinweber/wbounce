...
class Wbounce_Admin_Options {
	...
	function settings_page() { ?>
		...
		<div id="tabs" class="ui-tabs">
			<?php
				printf( '<h2>' . WBOUNCE_PLUGIN_NAME . '<span class="subtitle">' . __( 'by <a href="%1$s" target="_blank" title="Website by Kevin Weber">Kevin Weber</a> (Version %2$s)', 'wbounce' ) . '</span></h2>',
					'http://kevinw.de/wb',
					WBOUNCE_VERSION_NUM
				);
			?>
			...
			<ul class="ui-tabs-nav">
		        <li><a href="#content"><?php esc_html_e( 'Content', 'wbounce' ); ?> <span class="newred_dot">&bull;</span></a></li>
		        <li><a href="#options"><?php esc_html_e( 'Options', 'wbounce' ); ?></a></li>
		        <li><a href="#styling"><?php esc_html_e( 'Styling', 'wbounce' ); ?></a></li>
		        <li><a href="#analytics"><?php esc_html_e( 'Analytics', 'wbounce' ); ?> <span class="newred_dot">&bull;</span></a></li>
		        <li><a href="#more" class="tab-orange tab-premium"><?php esc_html_e( '15% coupon for OptinMonster', 'wbounce' ); ?> <span class="newred_dot">&bull;</span></a></li>
			...
			<form method="post" action="options.php">
			    ...
			    <div id="content">
					...
					<h3><?php esc_html_e( 'Content', 'wbounce' ); ?></h3>
				    ...
				    <table class="form-table">
					    <tbody>
					        ...
					        <tr valign="top">
					        	<th scope="row"><?php esc_html_e( 'Default status', 'wbounce' ); ?></th>
						        <td>
									<select class="select" typle="select" name="<?php echo WBOUNCE_OPTION_KEY; ?>_status_default">
								    	<option value="on"<?php if (get_option(WBOUNCE_OPTION_KEY.'_status_default') === 'on') { echo ' selected="selected"'; } ?>><?php esc_html_e( 'Always fire', 'wbounce' ); ?></option>
					        ...
					        <tr valign="top">
					        	<th scope="row"><?php esc_html_e( 'Template Engine', 'wbounce' ); ?> <span class="newred"><?php esc_html_e( 'New!', 'wbounce' ); ?></span></th>
						        <td>
									<select class="select" typle="select" name="<?php echo WBOUNCE_OPTION_KEY; ?>_template_engine">
								    	<option value="enabled"<?php if (get_option(WBOUNCE_OPTION_KEY.'_template_engine') === 'enabled') { echo ' selected="selected"'; } ?>><?php esc_html_e( 'Enabled', 'wbounce' ); ?></option>
								    	<option value="disabled"<?php if (get_option(WBOUNCE_OPTION_KEY.'_template_engine') === 'disabled') { echo ' selected="selected"'; } ?>><?php esc_html_e( 'Disabled (No Override)', 'wbounce' ); ?></option>
		     						</select>
						        </td>
					        </tr>
					        <tr valign="top">
					        	...
					        	<td>
					        		...
					        		<span>
					        			...
					        			<?php esc_html_e( 'Exemplary template:', 'wbounce' ); ?><br>
<pre>
&lt;div class=&quot;modal-title&quot;&gt;
  &lt;h3&gt;<?php esc_html_e( 'Title', 'wbounce' ); ?>&lt;/h3&gt;
&lt;/div&gt;

&lt;div class=&quot;modal-body&quot;&gt;
  &lt;p&gt;<?php esc_html_e( 'Paragraph', 'wbounce' ); ?>&lt;/p&gt;

  &lt;form&gt;
    &lt;input type=&quot;email&quot; placeholder=&quot;<?php esc_html_e( 'you@email.com', 'wbounce' ); ?>&quot;&gt;
    &lt;input type=&quot;submit&quot; value=&quot;<?php esc_html_e( 'learn more &raquo;', 'wbounce' ); ?>&quot;&gt;
    &lt;p class=&quot;form-notice&quot;&gt;<?php esc_html_e( '*this is a fake form', 'wbounce' ); ?>&lt;/p&gt;
  &lt;/form&gt;
&lt;/div&gt;

&lt;div class=&quot;modal-footer&quot;&gt;
  &lt;p&gt;<?php esc_html_e( 'no thanks', 'wbounce' ); ?>&lt;/p&gt;
&lt;/div&gt;
</pre>
			    ...
			    <div id="options">
					...
					<h3><?php esc_html_e( 'Options', 'wbounce' ); ?></h3>
				    ...
				    <table class="form-table">
					    <tbody>
					        ...
					        <tr valign="top">
						        <th scope="row"><?php esc_html_e( 'Cookie expiration', 'wbounce' ); ?></th>
						        <td>
						        	<input type="number" name="<?php echo WBOUNCE_OPTION_KEY; ?>_cookieexpire" placeholder="days" value="<?php echo get_option(WBOUNCE_OPTION_KEY.'_cookieexpire'); ?>" /><br><label><?php esc_html_e( 'wBounce sets a cookie by default to prevent the modal from appearing more than once per user. You can add a cookie expiration (in days) to adjust the time period before the modal will appear again for a user. By default, the cookie will expire at the end of the session, which for most browsers is when the browser is closed entirely.', 'wbounce' ); ?></label>
						        </td>
					        </tr>
					        <tr valign="top">
						        <th scope="row"><?php esc_html_e( 'Cookie per page', 'wbounce' ); ?></th>
						        <td>
									<input name="<?php echo WBOUNCE_OPTION_KEY; ?>_sitewide" type="checkbox" value="1" <?php checked( '1', get_option( WBOUNCE_OPTION_KEY.'_sitewide' ) ); ?> /> <label><?php esc_html_e( 'By default, the cookie is stored for the whole site. With the "cookie per page" option enabled, every page/post gets its own cookie.', 'wbounce' ); ?></label>
						        </td>
					        </tr>
					        <tr valign="top">
					        	<th scope="row"><?php esc_html_e( 'Cookie domain', 'wbounce' ); ?></th>
					        	<td>
					        ...
					        <tr valign="top">
						        <th scope="row"><?php esc_html_e( 'Load script in footer', 'wbounce' ); ?></th>
						        <td>
			    ...
			    <div id="styling">
					...
					<h3><?php esc_html_e( 'Styling', 'wbounce' ); ?></h3>
